...
@Component({
  ...
  templateUrl: './emp-put-employees.component.html',
  styleUrls: ['./emp-put-employees.component.css']
})
export class EmpPutEmployeesComponent implements OnInit {
  ...
  loadEmployeeData(): void {
    this.empleadoService.getEmployeeById(this.employeeId).subscribe({
      next: (employee) => {
        ...
        // Cargar contacto
        this.telefono = employee.telephoneValue?.toString() || '';
        this.mail = employee.emailValue || '';
